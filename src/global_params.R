...
tissue_colors <- c(`brain`=  "#f5899e", `central_nervous_system`= "#f5899e",`engineered_central_nervous_system` = "#f5899e",
                   `teratoma` = "#f5899e",
                   `bone` = "#9f55bb",   
                   `pancreas` = "#b644dc", 
                   `rhabdomyosarcoma` = "#5fdb69", `soft_tissue` = "#5fdb69",
                   `skin` = "#6c55e2",    
                   `liver` = "#9c5e2b",
                   `leukemia` = "#da45bb",  `blood` = "#da45bb",
                   `lymphoma` = "#abd23f",  `lymphocyte`=  "#abd23f",
                   `neuroblastoma` = "#73e03d", `peripheral_nervous_system` = "#73e03d",
